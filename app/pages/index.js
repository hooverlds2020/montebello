  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', fontFamily: 'sans-serif' }}>
      ...
      <header style={{ padding: '20px 24px', display: 'flex', justifyContent: 'center' }}>
        ...
        <img src="/img/logo-montebello.webp" alt="Instituto Educativo Montebello" style={{ width: 110, height: 'auto' }} />
      </header>

      {/* Contenido principal */}
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ textAlign: 'center', maxWidth: 640 }}>
          <h1 style={{ fontSize: 30, color: '#0d3b66', margin: '0 0 8px 0' }}>
          ...
          <div style={{ display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link
              href="/login"
              style={{
                display: 'block', textDecoration: 'none', width: 260, padding: '28px 24px',
                background: '#0d3b66', color: '#fff', borderRadius: 14,
            ...
            <Link
              ...
              style={{
                display: 'block', textDecoration: 'none', width: 260, padding: '28px 24px',
                background: '#fff', color: '#0d3b66', borderRadius: 14,
